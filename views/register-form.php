...
<body>
    <div class="h-[calc(100vh-60px)] bg-orange-500 m-[30px] rounded">
        <div class="h-screen flex flex-col items-center justify-center justify-start gap-10">
            ...
            <div class="">
                <form action="/../controllers/registerController.php" aria-label="Formulaire d'inscription" class="flex flex-col border rounded gap-5 bg-[#f1d0a4] p-6 px-12 pt-12" method="POST">
                    <div class="border rounded p-3 bg-[#b6c2a3]" aria-label="Champ Prenom">
                        <label for="">Prenom</label>
                        <input class="px-3 py-1" type="text" name="firstname" required>
                    </div>
                    <div class="border rounded p-3 bg-[#b6c2a3]" aria-label="Champ Nom">
                        <label for="">Nom</label>
                        <input class="px-3 py-1" type="text" name="lastname" required>
                    </div>
                    <div class="border rounded p-3 bg-[#b6c2a3]" aria-label="Champ Portable">
                        <label for="">Portable</label>
                        <input class="px-3 py-1" type="number" name="phone" required>
                    </div>
                    <div class="border rounded p-3 bg-[#b6c2a3]" aria-label="Champ Civilité">
                        <label for="civilite">Civilité</label>
                        <select class="px-3 py-1 text-center" name="civicness" id="civilite">
